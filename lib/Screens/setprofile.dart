      ...
      child: Scaffold(
        body: Column(
          children: [
            ...
            Text('WELCOME', style: ColorConst.headingStyle1),
            Flexible(child: SizedBox(height: 10)),
            Text('complete your profile', style: ColorConst.headingStyle2),
                ...
                ? Container(
                    ...
                    child: Center(
                        child: InkWell(
                            ...
                            child: Text(
                              'upload photo',
                              style: ColorConst.headingStyle1,
                            ))),
                  )
                : Container(
                    width: _width,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            BUttonwidget(text: 'motorcycle', fontSize: 20),
                          ],
                        ),
                      ],
                    ),
