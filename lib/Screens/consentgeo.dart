...
import 'package:mooovie_app/Screens/consentnotif.dart';
import 'package:mooovie_app/Widgets/buttonwidget.dart';
import 'package:mooovie_app/Widgets/textfieldwidget.dart';

import '../Constants/color_constants.dart';
class ConsentGeo extends StatelessWidget {
  const ConsentGeo({Key? key}) : super(key: key);
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ConsentNotification()),
                    );
                  },
                  child: Container(
